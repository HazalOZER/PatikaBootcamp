...
public class Test <T1,T2,T3>{
    ...
    public void showInfo(){
        System.out.println("T1 : "+getObj1()+" : "+obj1.getClass().getSimpleName());
        System.out.println("T2 : "+getObj2()+" : "+obj2.getClass().getSimpleName());
        System.out.println("T3 : "+getObj3()+" : "+obj3.getClass().getSimpleName());
    }
